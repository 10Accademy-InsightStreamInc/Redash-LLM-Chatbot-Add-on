...
class ChatResource(BaseResource):
    ...
    def ask_database(self, query):
        ...
        This function takes a SQL query as input and executes it against the Postgres database.
        The function establishes a connection to the database using the `engine` object created earlier.
        The `text` function is used to create a SQLAlchemy TextClause object, which is then used to execute the query.
        The `fetchall` method is called on the result to retrieve all rows from the query result.
        
        Parameters:
        - query (str): The SQL query to be executed.
        
        Returns:
        - result (list): A list of tuples, where each tuple represents a row of the query result.
        
        Exception Handling:
        - If any exception occurs during the execution of the query, the function catches the exception and returns a string indicating the error.
        """
        try:
            # Establish a connection to the database using the engine object.
            connection = self.engine.connect()
            # Create a SQLAlchemy TextClause object from the query string.
            # This object is then used to execute the query against the database.
            ...
            # If an exception occurs, catch it and return a string indicating the error.
