...
export default function ChatBox() {
  ...
  async function chatWithOpenai(text) {
    ...
    axios.post(saveOrCreateUrl(query_params), query_params).then(getQuery)
  }
